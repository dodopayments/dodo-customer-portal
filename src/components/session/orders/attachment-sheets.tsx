...
export const AttachmentsSheet = ({ isAttachmentsSheetOpen, setIsAttachmentsSheetOpen, digitalProductsLoading, digitalProducts, error }: AttachmentsSheetProps) => {
    return (
                        ...
                        {digitalProductsLoading ? (
                            ...
                            (() => {
                                ...
                                if (!digitalProducts || (!hasFiles && !externalUrl && !instructions)) {
                                    return <p className="text-sm text-muted-foreground">No digital products available.</p>;
                                }
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        {externalUrl && (
                                            <div>
                                                ...
                                                <Button variant="secondary" onClick={() => window.open(externalUrl, '_blank')}>Open</Button>
                                            </div>
                                        )}
