...
export function WalletsSection({
  ...
  const t = useTranslations("WalletsSection");
            ...
            <SelectContent>
              {wallets.map((wallet) => (
                <SelectItem key={wallet.currency} value={wallet.currency}>
                  {t("walletLabel", { currency: wallet.currency })}
                </SelectItem>
              ))}
            </SelectContent>
          </Select>
      ...
      <Card>
        <CardContent className="p-4 sm:p-6 md:p-8">
          <div className="text-center py-4 sm:py-6 mb-6 sm:mb-8">
            ...
            <p className="text-sm text-text-secondary">{t("availableBalance")}</p>
          </div>
                ...
                walletLedger.map((ledgerItem) => (
                  ...
                  >
                    <div className="flex items-center justify-between sm:hidden">
                      ...
                      >
                        {ledgerItem.is_credit ? t("credit") : t("debit")}
                      </Badge>
                      <span
                        className={cn(
                          "text-sm font-medium",
