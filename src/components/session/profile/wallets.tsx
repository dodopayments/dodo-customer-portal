...
export function Wallet({ wallets, allWallets, tab, walletLedger }: { wallets: WalletItem[], allWallets: { value: string, label: string, link: string }[], tab: string, walletLedger: WalletLedgerItem[] }) {
    ...
    const currentWalletLedger: WalletLedgerItem[] = walletLedger.find((ledger: WalletLedgerItem) => ledger.currency?.toUpperCase() === selectedCurrency);
    return (
