...
function getPinningStyles<TData>(column: Column<TData>): CSSProperties {
  ...
  return {
    ...
    backgroundColor: isPinned ? "var(--bg-primary)" : undefined,
    boxShadow: isPinned ? "2px 0 8px rgba(0,0,0,0.1)" : undefined,
  };
}
...
function DataGridTableHeadRowCell<TData>({
  ...
  return (
    <th
      ...
      className={cn(
        "relative h-12 text-left rtl:text-right align-middle font-normal !text-text-secondary [&:has([role=checkbox])]:pe-0",
        headerCellSpacing,
        ...
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          "[&:not([data-pinned]):has(+[data-pinned])_div.cursor-col-resize:last-child]:opacity-0 [&[data-last-col=left]_div.cursor-col-resize:last-child]:opacity-0 [&[data-pinned=left][data-last-col=left]]:border-e! [&[data-pinned=right]:last-child_div.cursor-col-resize:last-child]:opacity-0 [&[data-pinned=right][data-last-col=right]]:border-s! [&[data-pinned][data-last-col]]:border-border-secondary-secondary data-pinned:bg-bg-primary data-pinned:backdrop-blur-xs",
  ...
  return (
    <div
      {...{
        ...
        className:
          "absolute top-0 h-full w-4 cursor-col-resize user-select-none touch-none -end-2 z-10 flex justify-center before:absolute before:w-px before:inset-y-0 before:bg-border-secondary before:-translate-x-px",
      }}
    />
  );
}
...
function DataGridTableBodyRowSkeleton({ children }: { children: ReactNode }) {
  ...
  return (
    <tr
      className={cn(
        "hover:bg-bg-secondary data-[state=selected]:bg-bg-secondary",
        props.onRowClick && "cursor-pointer",
        !props.tableLayout?.stripped &&
          props.tableLayout?.rowBorder &&
          "border-b border-border-secondary [&:not(:last-child)>td]:border-b",
        props.tableLayout?.cellBorder && "[&_>:last-child]:border-e-0",
        props.tableLayout?.stripped &&
  ...
  return (
    <td
      className={cn(
        ...
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          '[&[data-pinned=left][data-last-col=left]]:border-e! [&[data-pinned=right][data-last-col=right]]:border-s! [&[data-pinned][data-last-col]]:border-border-secondary data-pinned:bg-bg-secondary data-pinned:backdrop-blur-xs"',
        column.getIndex() === 0 ||
...
function DataGridTableLoader() {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <div className="text-text-secondary bg-card  flex items-center gap-2 px-4 py-2 font-medium leading-none text-sm border border-border-secondary shadow-xs rounded-md">
        <svg
          className="animate-spin -ml-1 h-5 w-5 text-text-secondary"
